...
/*
TODO transform to game
	define
		boundary cylinder
		start point
		end point
		rings with randomly assigned position
			inside the cylinder (X, Y)
			between start and end (Z)
		assign Camera.lookAt to Tween Camera.position
	refinments
		display rings centered in the cylender then tweening to their positino
		more types of items to aim or avoid, etc
		record time
			end time - start time
		record points
			recorded time
			X,Y proximity with targets
*/
